...
class Change(BaseModel):
    ...
    scope: str | None = Field(None, description="Scope of the change")
...
class Version(BaseModel):
    ...
    summary: str | None = Field(None, description="AI-generated version summary")
    ...
    yanked: bool = Field(
        False,
        description="Whether this version was yanked"
    )
    compare_url: str | None = Field(
        None,
        description="URL to compare with previous version"
    )
